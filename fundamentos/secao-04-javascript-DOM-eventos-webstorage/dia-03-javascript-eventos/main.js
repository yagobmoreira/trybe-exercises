...
//Porque esse li possui uma classe tech que está com uns transform: translateY(-20px) no CSS
...
myWebpage.addEventListener('dblclick',(evento) => {
  window.location.replace('https://yagobmoreira.github.io/')
})
